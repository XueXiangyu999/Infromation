...
<div id="login_background">
    <div id="login_main">
            ...
            <p id="login_zhushi">注：账号为<span>学工号</span>或<span>学号</span></p>
    </div>  
</div>
</template>
...
export default {
        ...
        sendAjax(){
            ...
            $.ajax({
                ...
                success : function(msg) {
                    ...
                    if(msg.msg=='用户不存在'&& msg.code==300){      //账号错误
                        $("#login_error").text(msg.msg);
                    };
                    if(msg.msg=='用户密码错误'&&msg.code==300){//密码错误
                        $("#login_error").text(msg.msg);
                    }
                },
                error : function(){
    ...
    mounted:function(){
    sessionStorage.setItem("path","http://10.14.4.148:8000")
     //已登录直接进入主界面
