                        ...
                        <template slot-scope="scope" width="">
                            <div v-if="scope.row.delete==false">
                                <div v-if="scope.row.type===1">
                                    ...
                                    size="mini" 
                                    @click="dialogFormVisible = true;saveform(scope.row)">查看
                                    </el-button>
                                    <el-button type="success" plain
                                    v-if="scope.row.submit&&scope.row.status==0"
                                    size="mini" 
                                    @click="dialogFormVisible = true;saveform(scope.row)">修改
                                    </el-button>
                                    <el-button type="success" plain
                                    ...
                                    <el-dialog title="请完成信息填写" :visible.sync="dialogFormVisible" id="bd_input" :close-on-click-modal="false">
                                        ...
                                        <div slot="footer" class="dialog-footer">
                                            ...
                                            <el-button v-else type="primary" @click="dialogFormVisible = false;submitbd(scope.row.id)">提 交</el-button>
                                        </div>
                                    </el-dialog>
                                </div>
                                <div v-else>
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.delete==false">
                                ...
                                <div v-else>
                                        ...
                                        <el-button size="small" type="text" v-if="!scope.row.file && scope.row.status==0" @click="saveid(scope.row.id)">上传文件</el-button>
                                        <el-button size="small" type="text" v-if="scope.row.status==1" @click="saveid(scope.row.id)" disabled>上传文件</el-button>
                                        </el-upload>
                                </div>
                            </div>
                            <div v-else>
