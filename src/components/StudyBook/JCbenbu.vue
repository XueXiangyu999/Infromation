...
export default {
  ...
  methods: {
    ...
    getAllData() {
      ...
      this.$http
        .post(this.$store.state.url + "textbook/getalldata", qs.stringify({}) , this.config)
        .then(res => {
    ...
    selectXQ() {
      this.$http
        .post(
          this.$store.state.url + "textbook/selectbyterm",
          qs.stringify({
    ...
    selectJYS() {
      this.$http
        .post(
          this.$store.state.url + "textbook/selectbylab",
    ...
    deleteRow(index, rows) {
      this.$http
        .post(
          this.$store.state.url + "textbook/deleteone",
          qs.stringify({
          ...
          if (res.status == 200) {
            ...
            switch (this.activeName) {
              case "first":
                this.$http
                  .post(
                    this.$store.state.url + "textbook/selectall",
                ...
                this.$http
                  .post(
                    this.$store.state.url + "textbook/getrows",
                    qs.stringify({}),
                    this.config
                  )
                  .then(res => {
    ...
    details(index, table) {
      ...
      this.$http
        .post(
          this.$store.state.url + "textbook/edit",
    ...
    PopupSuccess(file) {
      ...
      this.$http
        .post(
          this.$store.state.url + "textbook/uploadexcel",
          formdata,
          this.config
        )
        .then(res => {
  ...
  mounted() {
    ...
    this.$http
      .post(this.$store.state.url + "textbook/getrows", qs.stringify({}) , this.config)
      .then(res => {
        console.log(res);
        for (let i = 1; i <= res.data; i++) {
          this.TBoptions[0].push(i);
