        ...
        <el-table :data="tableData_show" style="width: 95%;margin:0 auto" :cell-style="{padding:'3px'}">
          ...
          <el-table-column label="状态">
            <template slot-scope="scope">
              ...
              <el-button class="buttonInner" v-if="tableData_show[scope.$index].status==0" type="primary">未处理</el-button>
            </template>
          </el-table-column>
        ...
        <el-table :data="tableData_Pass_show" style="width: 95%;margin:0 auto" :cell-style="{padding:'3px'}">
          ...
          <el-table-column label="状态">
            <template slot-scope="scope">
              ...
              <el-button class="buttonInner" v-if="tableData_Pass_show[scope.$index].status==0" type="primary">未处理</el-button>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    pass(index, data) {
      this.$http
        .post(this.$store.state.url + "appointment/manager/book/" + data[index].id + "/" + 1, null, this.config)
        .then(res => {
          console.log(res);
          this.init();
        })
    ...
    init() {
      this.$http
        .get(this.$store.state.url + "appointment/manager/book/all", this.config)
        .then(res => {
          this.tableData = [];
